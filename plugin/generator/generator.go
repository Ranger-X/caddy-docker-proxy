...
import (
	...
	"github.com/Ranger-X/caddy-docker-proxy/plugin/v2/caddyfile"
	"github.com/Ranger-X/caddy-docker-proxy/plugin/v2/config"
	"github.com/Ranger-X/caddy-docker-proxy/plugin/v2/docker"
)
